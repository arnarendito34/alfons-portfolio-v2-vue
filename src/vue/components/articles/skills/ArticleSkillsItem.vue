<template>
    <div class="skills-item"
        ...
        <div class="skills-item-content"
            :class="{ 'no-description': !localize(item.locales, 'description', true) }">
            <!-- Header -->
...
div.skills-item-content {
    ...
    @include generate-dynamic-styles-with-hash((
        xxxl:   (margin-left: 18px, margin-top: 4px),
        md:     (margin-left: 15px, margin-top: 3px),
...
div.skills-item-header {
    ...
    align-items: center; /* Ini kunci agar teks sejajar tengah dengan ikon */
}
